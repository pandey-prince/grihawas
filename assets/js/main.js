...
(function () {
  ...
  (function setupMultiStep() {
    ...
    wizard.querySelector("form").addEventListener("submit", async function (e) {
      e.preventDefault();
      ...
      try {
        const response = await fetch(`${CFG.API_BASE_URL}/api/applications`, {
          method: "POST",
        ...
        // Hide the step tracker
        const stepTracker = wizard.querySelector(".step-tracker");
        ...
        const notice = document.getElementById("applySuccess");
        ...
        <p class="mb-0">
            Thank you for applying to Grihawas.
            Our sales team will contact you within
            one business day to confirm the next steps.
        </p>
    `;
